...
constexpr uint8_t YEAR_BCD =
    ((BUILD_YEAR_CH2 - '0') << 4) | (BUILD_YEAR_CH3 - '0');
...
constexpr uint8_t MONTH_BCD =
    ((BUILD_MONTH_CH0 - '0') << 4) | (BUILD_MONTH_CH1 - '0');

#define BUILD_DAY_CH0 ((__DATE__[4] >= '0') ? (__DATE__[4]) : '0')
#define BUILD_DAY_CH1 (__DATE__[5])

constexpr uint8_t DAY_BCD =
    ((BUILD_DAY_CH0 - '0') << 4) | (BUILD_DAY_CH1 - '0');
